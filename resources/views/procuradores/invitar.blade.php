...
@section('title', 'Invitar Procurador')
    ...
    <div class="container mt-5">
        <div class="row">
                ...
                <div class="author-card pb-3">
                    ...
                    <div class="author-card-profile">
                        ...
                        <div class="author-card-details">
                            <h5 class="author-card-name text-lg">{{$attorney->name}}</h5>
                            <span class="author-card-position">se unio {{$attorney->created_at->diffForHumans()}}</span>
                        </div>
                    </div>
                </div>
                <div class="wizard">
            ...
            <div class="col-lg-8 pb-5">
                <form action="{{route('procuradores.store',$attorney->id)}}" class="row" method="POST">
                     @csrf
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="account-fn">Codigo del caso</label>
                            {{-- <input class="form-control" type="text" id="account-fn" value="Daniel" required=""> --}}
                            <select id="inputjudge" name="codecaso" class="form-control form-control-lg">
                                @foreach ($casos as $caso)
                                    <option selected>{{ $caso->code }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="account-ln">Vistas de casos</label>
                            <select id="inputjudge" name="" class="form-control form-control-lg">
                                @foreach ($casos as $caso)
                                    <option selected>{{ $caso->code . '  :  ' . $caso->title }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 mt-4">
                        <div class="form-group">
                            <label for="">Titulo de Invitacion</label>
                            <input name="titlecaso" class="form-control" type="text" id="" value="">
                        </div>
                    </div>
                    <div class="col-md-6"></div>
                     ...
                     <div class="col-md-6 mt-4">
                        <div class="form-group">
                            <label for="account-phone">Para:</label>
                            <input name="nameattorney" class="form-control" type="text" id="account-phone" value="{{$attorney->name}}"
                             required="" readonly>
                        </div>
                    </div>

                    <div class="col-sm-6 col-md-8 col-lg-12 mt-4 mb-4">
                        <div class="form-group">
                    ...
                    <div class="col-12">
                        ...
                        <div class="d-flex flex-wrap justify-content-between align-items-center">
                            ...
                            <button class="btn btn-style-1 btn-primary btn-lg" type="submit" data-toast=""
                                data-toast-position="topRight" data-toast-type="success"
                                data-toast-icon="fe-icon-check-circle" data-toast-title="Success!"
                                data-toast-message="Your profile updated successfuly.">Enviar</button>
                        </div>
                    </div>
                </form>
            </div>
